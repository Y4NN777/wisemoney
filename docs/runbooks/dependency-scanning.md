...
and `toolchain go1.25.13` but still be built with a different toolchain if the
...
(`golang:1.25.13-bookworm`). Without it, Go may silently download a different
...
**Cause:** The `toolchain go1.25.13` line was stripped from `go.mod`. This happens
...
**The binary was never vulnerable** — the Dockerfile pins `golang:1.25.13-bookworm`
...
- Go toolchain — 1.25.13 (clears GO-2026-5026, GO-2026-5972,
  GO-2026-6088/6089/6090, GO-2026-6218, and prior stdlib advisories)
