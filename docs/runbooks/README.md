...
| [provider-terms-verification.md](./provider-terms-verification.md) | Launch-blocker verification of AI provider data-handling terms (S0). | Verified 2026-06-05 — pending legal sign-off + consent-UI naming |
