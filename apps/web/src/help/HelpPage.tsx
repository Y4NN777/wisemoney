...
export default function HelpPage({ visible }: { visible: boolean }) {
  ...
  return (
    <div className="help-page min-h-dvh bg-background text-foreground">
      ...
      <main>
        ...
        <section className="border-b border-border bg-muted">
          <div className="mx-auto grid max-w-[1440px] gap-0 lg:grid-cols-[minmax(250px,0.45fr)_minmax(0,1.55fr)]">
            <label htmlFor="help-search" className="flex items-center border-b border-border px-4 py-4 text-sm font-bold lg:border-b-0 lg:border-r lg:px-8">
        ...
        <div className="mx-auto grid max-w-[1440px] lg:grid-cols-[minmax(250px,0.45fr)_minmax(0,1.55fr)]">
          <nav aria-label={t("helpPage.contents")} className="hidden border-r border-border p-8 lg:block">
            <p className="mb-5 text-xs font-bold uppercase tracking-[0.12em] text-muted-foreground">{t("helpPage.contents")}</p>
          ...
          <section aria-label={t("helpPage.results")} className="min-w-0">
            {query.length > 0 && (
              <div className="border-b border-border bg-ocean-wash px-4 py-3 text-sm sm:px-8">
            ...
            {results.length === 0 ? (
              <div className="px-4 py-20 text-center sm:px-8">
                ...
                <p className="mt-2 text-sm text-muted-foreground">{t("helpPage.noResultHint")}</p>
              </div>
            ) : (
                  ...
                  return (
                    <li id={section.id} key={`${section.id}-${query}`} className="scroll-mt-20">
                      <details className="group" open={query.length > 0 || window.location.hash === `#${section.id}`}>
                        ...
                        <div className="grid border-t border-border bg-muted sm:grid-cols-[6.5rem_1fr]">
